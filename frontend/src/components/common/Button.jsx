...
export default function Button({
  ...
  const variants = {
    ...
    secondary: 'btn-secondary focus:ring-slate-400 active:scale-95',
    danger: 'btn-danger focus:ring-rose-400 shadow-sm active:scale-95',
    ghost: 'btn-ghost focus:ring-slate-400 active:scale-95',
  };
